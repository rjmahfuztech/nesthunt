...
from bookings.views import RentRequestViewSet, MyRentRequestViewSet, FavouriteViewSet, OrderViewSet, payment_initiate, payment_success, payment_fail, payment_cancel
